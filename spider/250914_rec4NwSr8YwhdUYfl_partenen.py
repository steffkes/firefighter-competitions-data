...
class CompetitionSpider(Spider):
    ...
    def parse_starters(self, response):
        for name in ["Stefan Matheis", "Marcel König", "Nicolas Faure", "Elias Vogt"]:
    ...
    def parse(self, response):
        ...
        for rank_total, (raw_duration, category, name) in enumerate(
            [
                ("00:46:20.03", "M", "Stefan Matheis"),
                ("00:47:33.30", "M", "Marcel König"),
                ("00:50:48.92", "M", "Nicolas Faure"),
                ("00:59:25.67", "M", "Elias Vogt"),
            ]
        ):
            yield ResultItem(
                date=self.race_date,
